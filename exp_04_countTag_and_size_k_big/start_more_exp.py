...
HEADER = "exp_04_countTag_and_size_k_big"

sizes = [
    [[-1, 32, 32]],
    [[-1, 64, 64], [64, 32, 32]],
    [[-1, 128, 128], [128, 64, 64], [64, 32, 32]],
    [[-1, 256, 256], [256, 128, 128], [128, 64, 64], [64, 32, 32]],
    [[-1, 512, 512], [512, 256, 256], [256, 128, 128], [128, 64, 64], [64, 32, 32]],
    [[-1, 1024, 1024],[1024, 512, 512], [512, 256, 256], [256, 128, 128], [128, 64, 64], [64, 32, 32]],
]
