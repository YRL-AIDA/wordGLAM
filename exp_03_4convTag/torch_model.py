...
class NodeGLAM(torch.nn.Module):
    def __init__(self,  input_, h, output_):
        ...
        self.linear4 = Linear(h[5], h[6]) 
        self.tag4 = TAGConv(h[6], h[7])

        self.linear5 = Linear(h[7] +input_, h[8])
        self.linear6 =Linear(h[8], h[9])
        self.classifer = Linear(h[9], output_)
