...
from .pager_models import featch_words_and_styles, featch_A_and_EdgesFeatures, nodes_feature
    ...
    for i, file in enumerate(files):
        ...
        try:
            ...
            json_with_featchs.add_featchs(lambda: featch_A_and_EdgesFeatures(json_with_featchs.json['words'],
                                                                             json_with_featchs.json['width'],
                                                                             json_with_featchs.json['height']), 
                                                                             names=['A', 'edges_feature'], 
